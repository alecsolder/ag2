...
```python
from autogen import register_hand_off, ON_CONDITION, AfterWorkOption
register_hand_off(
    agent=responder,
    hand_to=[
...
```python
from autogen import initiate_swarm_chat, ConversableAgent, SwarmResult, ON_CONDITION, AFTER_WORK, AfterWorkOption
